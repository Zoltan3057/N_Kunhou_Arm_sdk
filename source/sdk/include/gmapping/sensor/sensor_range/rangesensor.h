...
class RangeSensor: public Sensor{
	...
	public:
		...
		RangeSensor(std::string name, unsigned int beams,double start_angle, double res, const OrientedPoint& position=OrientedPoint(0,0,0), double span=0, double maxrange=89.0);
